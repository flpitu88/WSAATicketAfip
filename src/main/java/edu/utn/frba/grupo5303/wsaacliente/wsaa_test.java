...
public class wsaa_test {
    ...
    public static void main(String[] args) {
        ...
        try {
            config.load(new FileInputStream("src/main/resources/wsaa_client.properties"));
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        String signer = config.getProperty("keystore-signer", "enviolibre");
        String p12pass = config.getProperty("keystore-password", "envioServer5303");
